...
- **주요 기능**:
  ...
  - PNG, JPEG, WebP 포맷 지원
  - 실시간 진행 상태 표시
  - **🆕 ZIP 파일 일괄 다운로드** - 모든 스크린샷을 한 번에 ZIP으로 다운로드
  - 생성된 스크린샷 개별 다운로드
...
3. **스크린샷 생성**
   - 옵션 설정 (화면 크기, 포맷 등)
   - "스크린샷 생성 시작" 버튼 클릭
   - 완료 후 "전체 ZIP 다운로드" 버튼으로 모든 스크린샷을 한 번에 다운로드
   - 또는 개별 스크린샷을 하나씩 다운로드
...
6. 완료 후 선택:
   - **"전체 ZIP 다운로드"** 버튼: 모든 스크린샷을 한 번에 ZIP 파일로 다운로드
   - **개별 다운로드**: 각 스크린샷 카드의 "다운로드" 버튼 클릭
